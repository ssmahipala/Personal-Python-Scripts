...
with open(output_file_path, 'w', newline='', encoding='utf-8') as csv_file:
    ...
    csv_writer.writerow(['prompt', 'image_filename', 'image_file'])  # Write header
    for prompt, image_filename in dataset:
        image_file_name = os.path.basename(image_filename)  # Extract the image file name
        csv_writer.writerow([prompt, image_filename, image_file_name])
